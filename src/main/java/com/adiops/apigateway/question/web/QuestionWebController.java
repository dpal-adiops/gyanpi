...
public class QuestionWebController {
	...
	@GetMapping(value = "/web/questions")
	...
	@GetMapping(value = { "/web/questions/add" })
	...
	@PostMapping(value = "/web/questions/add")
	...
	@GetMapping(value = { "/web/questions/{questionId}" })
	...
	@GetMapping(value = { "/web/questions/{questionId}/delete" })
	public String deleteQuestionById(Model model, @PathVariable Long questionId) throws RestException {
		...
		return "redirect:/web/questions";
	}
	
	
	@GetMapping(value = { "/web/questions/{questionId}/topics" })
	public String getQuestionTopics(Model model, @PathVariable Long questionId) throws RestException {
		...
		model.addAttribute("selectedMenu", "question");
		return "question/topic/topic-list";
	}
	
	@GetMapping(value = { "/web/questions/{questionId}/topics/assign" })
	public String assignTopics(Model model, @PathVariable Long questionId) throws RestException {
		...
		model.addAttribute("selectedMenu", "question");
		return "question/topic/topic-assign";
	}
	
	@GetMapping(value = { "/web/questions/{questionId}/topics/{topicId}/assign" })
	...
	@GetMapping(value = { "/web/questions/{questionId}/topics/{topicId}/unassign" })
	...
	@GetMapping(value = { "/web/questions/{questionId}/images" })
	public String getQuestionImages(Model model, @PathVariable Long questionId) throws RestException {
		...
		model.addAttribute("selectedMenu", "question");
		return "question/image/image-list";
	}
	
	@GetMapping(value = { "/web/questions/{questionId}/images/assign" })
	public String assignImages(Model model, @PathVariable Long questionId) throws RestException {
		...
		model.addAttribute("selectedMenu", "question");
		return "question/image/image-assign";
	}
	
	@GetMapping(value = { "/web/questions/{questionId}/images/{imageId}/assign" })
	...
	@GetMapping(value = { "/web/questions/{questionId}/images/{imageId}/unassign" })
	...
	@GetMapping(value = { "/web/questions/{questionId}/videos" })
	public String getQuestionVideos(Model model, @PathVariable Long questionId) throws RestException {
		...
		model.addAttribute("selectedMenu", "question");
		return "question/video/video-list";
	}
	
	@GetMapping(value = { "/web/questions/{questionId}/videos/assign" })
	public String assignVideos(Model model, @PathVariable Long questionId) throws RestException {
		...
		model.addAttribute("selectedMenu", "question");
		return "question/video/video-assign";
	}
	
	@GetMapping(value = { "/web/questions/{questionId}/videos/{videoId}/assign" })
	...
	@GetMapping(value = { "/web/questions/{questionId}/videos/{videoId}/unassign" })
	...
	@GetMapping(value = { "/web/questions/{questionId}/pages" })
	public String getQuestionPages(Model model, @PathVariable Long questionId) throws RestException {
		...
		model.addAttribute("selectedMenu", "question");
		return "question/page/page-list";
	}
	
	@GetMapping(value = { "/web/questions/{questionId}/pages/assign" })
	public String assignPages(Model model, @PathVariable Long questionId) throws RestException {
		...
		model.addAttribute("selectedMenu", "question");
		return "question/page/page-assign";
	}
	
	@GetMapping(value = { "/web/questions/{questionId}/pages/{pageId}/assign" })
	...
	@GetMapping(value = { "/web/questions/{questionId}/pages/{pageId}/unassign" })
