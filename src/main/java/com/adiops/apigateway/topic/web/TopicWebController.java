...
public class TopicWebController {
	...
	@GetMapping(value = { "/web/topics/add" })
	...
	@PostMapping(value = "/web/topics/add")
	...
	@GetMapping(value = { "/web/topics/{topicId}" })
	...
	@GetMapping(value = { "/web/topics/{topicId}/delete" })
	public String deleteTopicById(Model model, @PathVariable Long topicId) throws RestException {
		...
		return "redirect:/web/topics";
	}
	
	
	@GetMapping(value = { "/web/topics/{topicId}/modules" })
	public String getTopicModules(Model model, @PathVariable Long topicId) throws RestException {
		...
		model.addAttribute("selectedMenu", "topic");
		return "topic/module/module-list";
	}
	
	@GetMapping(value = { "/web/topics/{topicId}/modules/assign" })
	public String assignModules(Model model, @PathVariable Long topicId) throws RestException {
		...
		model.addAttribute("selectedMenu", "topic");
		return "topic/module/module-assign";
	}
	
	@GetMapping(value = { "/web/topics/{topicId}/modules/{moduleId}/assign" })
	...
	@GetMapping(value = { "/web/topics/{topicId}/modules/{moduleId}/unassign" })
	...
	@GetMapping(value = { "/web/topics/{topicId}/questions" })
	public String getTopicQuestions(Model model, @PathVariable Long topicId) throws RestException {
		...
		model.addAttribute("selectedMenu", "topic");
		return "topic/question/question-list";
	}
	
	@GetMapping(value = { "/web/topics/{topicId}/questions/assign" })
	public String assignQuestions(Model model, @PathVariable Long topicId) throws RestException {
		...
		model.addAttribute("selectedMenu", "topic");
		return "topic/question/question-assign";
	}
	
	@GetMapping(value = { "/web/topics/{topicId}/questions/{questionId}/assign" })
	...
	@GetMapping(value = { "/web/topics/{topicId}/questions/{questionId}/unassign" })
	...
	@GetMapping(value = { "/web/topics/{topicId}/images" })
	public String getTopicImages(Model model, @PathVariable Long topicId) throws RestException {
		...
		model.addAttribute("selectedMenu", "topic");
		return "topic/image/image-list";
	}
	
	@GetMapping(value = { "/web/topics/{topicId}/images/assign" })
	public String assignImages(Model model, @PathVariable Long topicId) throws RestException {
		...
		model.addAttribute("selectedMenu", "topic");
		return "topic/image/image-assign";
	}
	
	@GetMapping(value = { "/web/topics/{topicId}/images/{imageId}/assign" })
	...
	@GetMapping(value = { "/web/topics/{topicId}/images/{imageId}/unassign" })
	...
	@GetMapping(value = { "/web/topics/{topicId}/videos" })
	public String getTopicVideos(Model model, @PathVariable Long topicId) throws RestException {
		...
		model.addAttribute("selectedMenu", "topic");
		return "topic/video/video-list";
	}
	
	@GetMapping(value = { "/web/topics/{topicId}/videos/assign" })
	public String assignVideos(Model model, @PathVariable Long topicId) throws RestException {
		...
		model.addAttribute("selectedMenu", "topic");
		return "topic/video/video-assign";
	}
	
	@GetMapping(value = { "/web/topics/{topicId}/videos/{videoId}/assign" })
	...
	@GetMapping(value = { "/web/topics/{topicId}/videos/{videoId}/unassign" })
	...
	@GetMapping(value = { "/web/topics/{topicId}/pages" })
	public String getTopicPages(Model model, @PathVariable Long topicId) throws RestException {
		...
		model.addAttribute("selectedMenu", "topic");
		return "topic/page/page-list";
	}
	
	@GetMapping(value = { "/web/topics/{topicId}/pages/assign" })
	public String assignPages(Model model, @PathVariable Long topicId) throws RestException {
		...
		model.addAttribute("selectedMenu", "topic");
		return "topic/page/page-assign";
	}
	
	@GetMapping(value = { "/web/topics/{topicId}/pages/{pageId}/assign" })
	...
	@GetMapping(value = { "/web/topics/{topicId}/pages/{pageId}/unassign" })
