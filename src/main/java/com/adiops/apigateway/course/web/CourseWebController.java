...
public class CourseWebController {
	...
	@GetMapping(value = { "/web/courses/add" })
	...
	@PostMapping(value = "/web/courses/add")
	...
	@GetMapping(value = { "/web/courses/{courseId}" })
	...
	@GetMapping(value = { "/web/courses/{courseId}/delete" })
	...
	@GetMapping(value = { "/web/courses/{courseId}/modules" })
	public String getCourseModules(Model model, @PathVariable Long courseId) throws RestException {
		...
		model.addAttribute("selectedMenu", "course");
		return "course/module/module-list";
	}
	
	@GetMapping(value = { "/web/courses/{courseId}/modules/assign" })
	public String assignModules(Model model, @PathVariable Long courseId) throws RestException {
		...
		model.addAttribute("selectedMenu", "course");
		return "course/module/module-assign";
	}
	
	@GetMapping(value = { "/web/courses/{courseId}/modules/{moduleId}/assign" })
	...
	@GetMapping(value = { "/web/courses/{courseId}/modules/{moduleId}/unassign" })
	...
	@GetMapping(value = { "/web/courses/{courseId}/images" })
	public String getCourseImages(Model model, @PathVariable Long courseId) throws RestException {
		...
		model.addAttribute("selectedMenu", "course");
		return "course/image/image-list";
	}
	
	@GetMapping(value = { "/web/courses/{courseId}/images/assign" })
	public String assignImages(Model model, @PathVariable Long courseId) throws RestException {
		...
		model.addAttribute("selectedMenu", "course");
		return "course/image/image-assign";
	}
	
	@GetMapping(value = { "/web/courses/{courseId}/images/{imageId}/assign" })
	...
	@GetMapping(value = { "/web/courses/{courseId}/images/{imageId}/unassign" })
	...
	@GetMapping(value = { "/web/courses/{courseId}/videos" })
	public String getCourseVideos(Model model, @PathVariable Long courseId) throws RestException {
		...
		model.addAttribute("selectedMenu", "course");
		return "course/video/video-list";
	}
	
	@GetMapping(value = { "/web/courses/{courseId}/videos/assign" })
	public String assignVideos(Model model, @PathVariable Long courseId) throws RestException {
		...
		model.addAttribute("selectedMenu", "course");
		return "course/video/video-assign";
	}
	
	@GetMapping(value = { "/web/courses/{courseId}/videos/{videoId}/assign" })
	...
	@GetMapping(value = { "/web/courses/{courseId}/videos/{videoId}/unassign" })
	...
	@GetMapping(value = { "/web/courses/{courseId}/pages" })
	public String getCoursePages(Model model, @PathVariable Long courseId) throws RestException {
		...
		model.addAttribute("selectedMenu", "course");
		return "course/page/page-list";
	}
	
	@GetMapping(value = { "/web/courses/{courseId}/pages/assign" })
	public String assignPages(Model model, @PathVariable Long courseId) throws RestException {
		...
		model.addAttribute("selectedMenu", "course");
		return "course/page/page-assign";
	}
	
	@GetMapping(value = { "/web/courses/{courseId}/pages/{pageId}/assign" })
	...
	@GetMapping(value = { "/web/courses/{courseId}/pages/{pageId}/unassign" })
